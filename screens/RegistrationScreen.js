        ...
        <View style={styles.form}>
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-evenly', alignItems: 'center'}}>
            <TouchableOpacity onPress={() => setSelectedRole("student")}>
              <View style={[
                styles.btn, 
                selectedRole === "student" ? styles.btnActive : styles.btnInactive
              ]}>
                <Text style={[
                  styles.btnText, 
                  selectedRole === "student" ? styles.textActive : styles.textInactive
                ]}>
                  Student
                </Text>
              </View>
            ...
            <TouchableOpacity onPress={() => setSelectedRole("employee")}>
              <View style={[
                styles.btn, 
                selectedRole === "employee" ? styles.btnActive : styles.btnInactive
              ]}>
                <Text style={[
                  styles.btnText, 
                  selectedRole === "employee" ? styles.textActive : styles.textInactive
                ]}>
                  Employee
                </Text>
              </View>
          ...
          <Text style={styles.formFooter}>Already have an account?</Text>
            <TouchableOpacity onPress={() => {
              ...
              <Text onPress={() => navigation.navigate("Home")} style={styles.reg}>Sign In</Text>
            </TouchableOpacity>
