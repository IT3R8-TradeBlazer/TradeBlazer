...
import { View, Text, TextInput, ScrollView, StyleSheet, Image, SafeAreaView, TouchableWithoutFeedback, TouchableOpacity, Keyboard } from "react-native";
...
export default function HomeScreen({ navigation }) {
  ...
  const [products, setProducts] = useState([
  {
    ...
    description: "A luxurious bouquet of Ferrero Rocher chocolates, perfect for gifting.",
    category: "Gift",
    isFavorite: false,
    sellerId: "syntyche",
    sellerName: "Syntyche"
  },
  {
    ...
    description: "A beautifully decorated cake adorned with elegant bows for any celebration.",
    category: "Gift",
    isFavorite: false,
    sellerId: "cypress",
    sellerName: "Cypress"
  },
  {
    ...
    description: "A handy set of hair clamps to keep your hairstyles neat and stylish.",
